...
@section('content')
    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('tags.index') }}">View All</a></li>
        ...
        <section class="content">
            ...
            <!-- Default box -->
            <form action="{{ route('tags.store') }}" method="POST" id="submitForm">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Ceate New Tag</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
